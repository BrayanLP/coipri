...
<html  >
    <head>
        ...
        <script type="text/javascript" src="http://coipri.pe/aplication/webroot/js/jquery-1.4.2.min.js"></script>         
        <script type='text/javascript' src='http://coipri.pe/aplication/webroot/js/jquery.easing.1.3.js'></script>       
    </head> 
<body>  
        <div id=" ">
                        ...
                        $(document).ready(function(){
                          $(function(){
                            ...
                            obj.scroll(function(){
                          	...
                          	// 			$(".colno1").css('position','absolute');
                          	// 			$(".colno1").css('margin-top',sumah-500+'px'); 
                          	// 			}
                        		if(obj_act_top2>0){
                        		$(".colno1").css('position','absolute');             
                                       $(".colno1").css('margin-top','0px'); 
