                    ...
                    <form name="login" action="index.php" method="post">
                        ...
                        <div id="password">
                            ...
                            <p>
                                ...
                                <input  name="recordar_si_MKD" value="si" <?php if(isset($_COOKIE['email_MKD']) && isset($_COOKIE['pass_MKD'])) { echo 'checked="checked"';}?> type="checkbox"  />
                                Recordarme por 30 días</label>
                                <input type="image" id="sign-in" name="enviar" src="<?php echo _admin_ ?>entrar.jpg" alt="Sign In" tabindex="3" />
                            </p>
                        </div>
