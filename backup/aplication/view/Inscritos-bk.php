...
class Inscritos {
        ...
        if($fechaActual <= $rof['fecha']){          
            ...
            while($ros = $secgru->VerRegistro()){
                ...
                <div class="presss">
                    ...
                    <input type="radio" name="tarifa" id="<?php echo $ros['id']?>" value="<?php echo $ros['id']?>" />
                </div>
                <?php
            }
            ?>
    ...
    public function listAdicionalesNacionales($idTar) {
        ...
        while($row = $query->VerRegistro()){
            ...
            <div class="adiccion">
                ...
                <input type="checkbox" name="adic<?php echo $row['id']?>" id="adic<?php echo $row['id']?>" onClick="if (this.checked) sumarCheck<?php echo $idTar; ?>(<?php echo $row['monto']?>); else restarCheck<?php echo $idTar; ?>(<?php echo $row['monto']?>); if (this.checked) this.value=<?php echo $row['monto']?>; else this.value='';"  value=""/>
            </div>
            <?php
        }
    }
    ...
    public function printTarifas() {
        ...
        while($row = $query->VerRegistro()){
        ?>
            <div class="titulo_fecha"><?php if($row['id'] == "1"){echo "Hasta el ";}else{echo "Desde el ";} ?><?php echo fecha_dia_mes($row['fecha']);?></div>
            <div class="precios">
                    <div class="personas">
                        Asociados:<br />
                        No Asociados:<br />
