...
class Sesion {
    ...
    function inicio($msgbox) {
        ...
        <?php if ($this->_usuario->getRol()->getNombre() == "Administrador") { ?>
                <li><a href="noticias.php"><img src="<?php echo _admin_ ?>icon-libros.jpg" /><span>Noticias</span></a></li>
                <li><a href="inscritos.php"><img src="<?php echo _admin_ ?>icon-clientes.jpg" /><span>Inscrítos</span></a></li>
