<?php 
  include 'header.php';
?>
<link rel="stylesheet" type="text/css" href="css/ponente.css">
...
<script type='text/javascript' src='https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js'></script> 
        ...
        <div class="container_fluid">
                <div class="row titlegeneral">
                  <div class="col s12 title">
                    <h2><strong><b>COIPRI</b></strong> 2014</h2>
                  </div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col s12 m6 l4">
                        <p class="textvideo">El 03 y 04 de Junio del 2014 se llevó a cabo el Tercer Congreso Internacional de Profesionales Inmobiliarios (COIPRI 2014) a manos de la Asociación Peruana de Agentes Inmobiliarios (ASPAI), logrando congregar a reconocidos especialistas nacionales e internacionales que expusieron sus puntos de vista y compartieron sus experiencias con todos los profesionales inmobiliarios e interesados que asistieron en las dos fechas. 
                        A continuación les mostramos el Video Resumen de lo que fue el COIPRI 2014.</p>
                    </div>
                    <div class="col s12 m6 l8">
                        <div class="videocoipri">                            
                            <div class="video-container">
                                <iframe width="560" height="500" src="https://www.youtube.com/embed/DWfJMUj2CdY" frameborder="0" allowfullscreen></iframe>
                              </div>
                        </div>
                    </div>
    ...
    <section class="expositores" ng-app="expositores" ng-controller="app">
            <div class="container_fluid">
                <div class="row titlegeneral">
                  <div class="col s12 title">
                    <h2>Expositores </h2>
            ...
            <div id=" ">
            <div id="contenedor" class="container" style="overflow:visible">
                      ...
                      <div id="contenido" style="overflow:visible"> 
                        <div class="sidebar-left">
                          <div id="sidebar" class="colno1">
                            ...
                            <div style="margin-top:660px"  class="menufixe2"></div>
                          </div>
                        </div>
                        ...
                        <div id="cajafk20" class="cafk">
                          <a id="20" name="20"></a>
                          <div class="img-expositor"><img src="http://coipri.pe/images/20.jpg"></div>
                          <div class="datos-expositor">
                            <div class="h35"></div>
                            <p><img src="http://coipri.pe/images/peru2.jpg"></p>
                          ...
                          <div class="redesexpositores">
                            <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=20','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                            <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Carlos+Paredes+Rodriguez - http://coipri.pe/expositores.php?fk=20','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                          </div>
                        ...
                        <div id="cajafk5" class="cafk">
                          <a id="5" name="5"></a>
                          <div class="img-expositor"><img src="http://coipri.pe/images/5.jpg"></div>
                          <div class="datos-expositor">
                            <div class="h35"></div>
                            <p><img src="http://coipri.pe/images/peru2.jpg"></p>
                          ...
                          <div class="redesexpositores">
                            <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=5','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                            <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Julio+Velarde - http://coipri.pe/expositores.php?fk=5','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                          </div>
                          <div class="h35"></div><div class="h35"></div>
                          <div class="linea"></div>
                          <div class="h35"></div><div class="h35"></div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/6.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=6','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Arnaldo+Aguirre+Brou - http://coipri.pe/expositores.php?fk=6','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/8.jpg"></div>
                        ...
                        <div class="datos-expositor">
                        <div class="h35"></div>
                        <p><img src="http://coipri.pe/images/espa2.jpg"></p>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=8','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Alfonso+Gordon - http://coipri.pe/expositores.php?fk=8','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/10.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=10','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Ang%C3%A9lica+M.+Portillo+Flores - http://coipri.pe/expositores.php?fk=10','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/18.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=18','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Aurora+Rodr%C3%ADguez+Valdivia - http://coipri.pe/expositores.php?fk=18','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/15.jpg"></div>

                        <div class="datos-expositor">
                        <div class="h35"></div>
                        <p><img src="http://coipri.pe/images/arge2.jpg"></p>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=15','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Carlos+Mar%C3%ADa+Ipuche - http://coipri.pe/expositores.php?fk=15','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/9.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=9','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Enrique+Cabrera+Otero - http://coipri.pe/expositores.php?fk=9','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/13.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=13','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Eric+Rey+de+Castro - http://coipri.pe/expositores.php?fk=13','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/14.jpg"></div>

                        <div class="datos-expositor">
                        <div class="h35"></div>
                        <p><img src="http://coipri.pe/images/eeuu2.jpg"></p>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=14','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Francisco+Angulo - http://coipri.pe/expositores.php?fk=14','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/12.jpg"></div>

                        <div class="datos-expositor">
                        <div class="h35"></div>
                        <p><img src="http://coipri.pe/images/bras2.jpg"></p>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=12','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Francisco+Pesserl - http://coipri.pe/expositores.php?fk=12','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/16.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=16','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Frederico+Mendonca - http://coipri.pe/expositores.php?fk=16','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/2.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=2','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Jose+Antonio+Arbul%C3%BA+Soto - http://coipri.pe/expositores.php?fk=2','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/4.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=4','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Arq.+Jos%C3%A9+Garc%C3%ADa+Calder%C3%B3n - http://coipri.pe/expositores.php?fk=4','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/17.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=17','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Luiz+Fernando+Barcellos - http://coipri.pe/expositores.php?fk=17','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/11.jpg"></div>

                        <div class="datos-expositor">
                        <div class="h35"></div>
                        <p><img src="http://coipri.pe/images/urug2.jpg"></p>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=11','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Mario+Stefanoli - http://coipri.pe/expositores.php?fk=11','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/7.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=7','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Percy+Vigil - http://coipri.pe/expositores.php?fk=7','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/19.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=19','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Philip+Reiser - http://coipri.pe/expositores.php?fk=19','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/1.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=1','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Arq.+Ricardo+Arbul%C3%BA+Soto - http://coipri.pe/expositores.php?fk=1','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        <div class="img-expositor"><img src="http://coipri.pe/images/3.jpg"></div>
                        ...
                        <div class="redesexpositores">
                        <p><a style="margin-right:5px;" href="javascript: void(0);" onClick="window.open('http://www.facebook.com/share.php?u=http://coipri.pe/expositores.php?fk=3','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');"><img src="http://coipri.pe/images/f.png"></a>
                          
                                              
                        <a  href="javascript: void(0);"  onclick="window.open('http://twitter.com/home?status=Steve+Brown - http://coipri.pe/expositores.php?fk=3','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');" ><img src="http://coipri.pe/images/t.png"></a></p>
                        </div>
                        ...
                        $(document).ready(function(){
                          $(function(){
                            ...
                            obj.scroll(function(){
                              ...
                              if(obj_act_top > (600)  ){
                                      $(".colno1").css('position','fixed');             
                                       $(".colno1").css('margin-top','-577px'); 
                                       $(".colno1").css('z-index','99'); 
                                    }
                                    if(obj_act_top<(600)){
                            ...
                            if(obj_act_top>(sumah)){
                                     $(".colno1").css('position','absolute');
                                     $(".colno1").css('margin-top',sumah-577+'px'); 
                                     }
                                if(obj_act_top2>0){
                                $(".colno1").css('position','absolute');             
                                       $(".colno1").css('margin-top','0px'); 
                        ...
                        function Movimiento(fk){
                            ...
                            if($.browser){
                                $('html').animate({scrollTop: $('#'+fk).offset().top-70}, 1000,'easeOutQuart');}
                                 else $('html,body').animate({scrollTop: $('#'+fk).offset().top-70}, 1000,'easeOutQuart');
                            }
                        </script>
...
<script type="text/javascript" src="js/expo-controller.js"></script>